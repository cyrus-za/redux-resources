...
export default (function (state, action) {
  ...
  switch (action.type) {
    ...
    case packageActions.SET_PACKAGE_IMAGE_URL:
      ...
      var packageIndex = packages.data.findIndex(function (item) {
    ...
    case packageActions.SET_DOCUMENT_IMAGE_URL:
      ...
      var docIndex = docs.data.findIndex(function (document) {
    ...
    case packageActions.SET_DOCUMENT_PAGE_IMAGE_URL:
      ...
      var doccyIndex = doccies.data.findIndex(function (document) {
        return document.id === action.documentId;
      });
      var paggyIndex = doccies.data[doccyIndex].pages.findIndex(function (page) {
