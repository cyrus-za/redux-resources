...
export var notificationActions = __assign(__assign({}, types), {
  ...
  getNotificationsInitialState: function () {
    return {
      type: types.GET_NOTIFICATIONS_INITIAL_STATE,
      payload: null
    };
  },
  getNotificationsLoading: function () {
    return {
      type: types.GET_NOTIFICATIONS_LOADING,
      payload: null
    };
  },
  getNotificationsFulfilled: function (response) {
    return {
      type: types.GET_NOTIFICATIONS_FULFILLED,
      payload: response
    };
  },
  getNotificationsRejected: function (response) {
    return {
      type: types.GET_NOTIFICATIONS_REJECTED,
      payload: response
    };
  },
  getTotalUnreadNotifications: function (query) {
    return {
  ...
  getTotalUnreadNotificationsInitialState: function () {
    return {
      type: types.GET_TOTAL_UNREAD_NOTIFICATIONS_INITIAL_STATE,
      payload: null
    };
  },
  getTotalUnreadNotificationsLoading: function () {
    return {
      type: types.GET_TOTAL_UNREAD_NOTIFICATIONS_LOADING,
      payload: null
    };
  },
  getTotalUnreadNotificationsFulfilled: function (response) {
    return {
      type: types.GET_TOTAL_UNREAD_NOTIFICATIONS_FULFILLED,
      payload: response
    };
  },
  getTotalUnreadNotificationsRejected: function (response) {
    return {
  ...
  updateNotificationInitialState: function () {
    return {
      type: types.UPDATE_NOTIFICATION_INITIAL_STATE,
      payload: null
    };
  },
  updateNotificationLoading: function () {
    return {
      type: types.UPDATE_NOTIFICATION_LOADING,
      payload: null
    };
  },
  updateNotificationFulfilled: function (response) {
    return {
      type: types.UPDATE_NOTIFICATION_FULFILLED,
      payload: response
    };
  },
  updateNotificationRejected: function (response) {
    return {
  ...
  deleteNotificationInitialState: function () {
    return {
      type: types.DELETE_NOTIFICATION_INITIAL_STATE,
      payload: null
    };
  },
  deleteNotificationLoading: function () {
    return {
      type: types.DELETE_NOTIFICATION_LOADING,
      payload: null
    };
  },
  deleteNotificationFulfilled: function () {
    return {
      type: types.DELETE_NOTIFICATION_FULFILLED,
      payload: null
    };
  },
  deleteNotificationRejected: function (response) {
    return {
      type: types.DELETE_NOTIFICATION_REJECTED,
      payload: response
    };
  },
  notificationReceivedEvent: function (response) {
    return {
      type: types.NOTIFICATION_RECEIVED_EVENT,
      payload: response
    };
  },
  addNotificationToList: function (response) {
    return {
  ...
  userConfirmedEmailEvent: function (response) {
    return {
      type: types.USER_CONFIRMED_EMAIL_EVENT,
      payload: response
    };
  },
  userUpdatedEmailEvent: function (response) {
    return {
      type: types.USER_UPDATED_EMAIL_EVENT,
      payload: response
    };
  },
  subscribeToUserEvents: function () {
    return {
      type: types.SUBSCRIBE_TO_USER_EVENTS,
      payload: null
    };
  },
  subscribeToUserEventsInitialState: function () {
    return {
      type: types.SUBSCRIBE_TO_USER_EVENTS_INITIAL_STATE,
      payload: null
    };
  },
  subscribeToUserEventsLoading: function () {
    return {
      type: types.SUBSCRIBE_TO_USER_EVENTS_LOADING,
      payload: null
    };
  },
  subscribeToUserEventsFulfilled: function () {
    return {
      type: types.SUBSCRIBE_TO_USER_EVENTS_FULFILLED,
      payload: null
    };
  },
  subscribeToUserEventsRejected: function (response) {
    return {
      type: types.SUBSCRIBE_TO_USER_EVENTS_REJECTED,
      payload: response
    };
  },
  connectToNotificationService: function () {
    return {
      type: types.CONNECT_TO_NOTIFICATION_SERVICE,
      payload: null
    };
  },
  connectToNotificationServiceInitialState: function () {
    return {
      type: types.CONNECT_TO_NOTIFICATION_SERVICE_INITIAL_STATE,
      payload: null
    };
  },
  connectToNotificationServiceLoading: function () {
    return {
      type: types.CONNECT_TO_NOTIFICATION_SERVICE_LOADING,
      payload: null
    };
  },
  connectToNotificationServiceFulfilled: function () {
    return {
      type: types.CONNECT_TO_NOTIFICATION_SERVICE_FULFILLED,
      payload: null
    };
  },
  connectToNotificationServiceRejected: function (response) {
    return {
      type: types.CONNECT_TO_NOTIFICATION_SERVICE_REJECTED,
      payload: response
    };
  },
  disconnectFromNotificationService: function () {
    return {
