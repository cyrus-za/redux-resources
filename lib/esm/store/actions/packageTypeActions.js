...
export var packageTypeActions = __assign(__assign({}, types), {
  getPackageTypes: function (query) {
    if (query === void 0) {
      query = {};
    }
  ...
  setPackageTypesLoading: function () {
    return {
      type: types.PACKAGE_TYPES_LOADING,
      payload: null
    };
  },
  setPackageTypesFulfilled: function (response) {
    return {
      type: types.PACKAGE_TYPES_FULFILLED,
      payload: response
    };
  },
  setPackageTypesRejected: function (data) {
    return {
