...
export var authActions = __assign(__assign({}, types), {
  authUserInitialState: function () {
    return {
      type: types.AUTH_USER_INITIAL_STATE,
      payload: null
    };
  },
  authUserLoading: function () {
    return {
      type: types.AUTH_USER_LOADING,
      payload: null
    };
  },
  authUserLoaded: function () {
    return {
      type: types.AUTH_USER_LOADED,
      payload: null
    };
  },
  authUserNotLoaded: function () {
    return {
      type: types.AUTH_USER_NOT_LOADED,
      payload: null
    };
  },
  authUserData: function (data) {
    return {
      type: types.AUTH_USER_DATA,
      payload: data
    };
  },
  authUserError: function (response) {
    return {
  ...
  createSocialAccessToken: function (provider, access_token, token_secret) {
    return {
  ...
  createUserInitialState: function () {
    return {
      type: types.CREATE_USER_INITIAL_STATE,
      payload: null
    };
  },
  createUserLoading: function () {
    return {
      type: types.CREATE_USER_LOADING,
      payload: null
    };
  },
  createUserFulfilled: function (response, user) {
    return {
  ...
  createUserRejected: function (response) {
    return {
  ...
  createAccessTokenInitialState: function () {
    return {
      type: types.CREATE_AUTH_ACCESS_TOKEN_INITIAL_STATE,
      payload: null
    };
  },
  createAccessTokenLoading: function () {
    return {
      type: types.CREATE_AUTH_ACCESS_TOKEN_LOADING,
      payload: null
    };
  },
  createAccessTokenFulfilled: function (response) {
    return {
      type: types.CREATE_AUTH_ACCESS_TOKEN_FULFILLED,
      payload: response
    };
  },
  createAccessTokenRejected: function (response) {
    return {
  ...
  updateAuthUserInitialState: function () {
    return {
      type: types.UPDATE_AUTH_USER_INITIAL_STATE,
      payload: null
    };
  },
  updateAuthUserLoading: function () {
    return {
      type: types.UPDATE_AUTH_USER_LOADING,
      payload: null
    };
  },
  updateAuthUserFulfilled: function (response) {
    return {
      type: types.UPDATE_AUTH_USER_FULFILLED,
      payload: response
    };
  },
  updateAuthUserRejected: function (response) {
    return {
  ...
  updateAuthPhotoInitialState: function () {
    return {
      type: types.UPDATE_AUTH_PHOTO_INITIAL_STATE,
      payload: null
    };
  },
  updateAuthPhotoLoading: function () {
    return {
      type: types.UPDATE_AUTH_PHOTO_LOADING,
      payload: null
    };
  },
  updateAuthPhotoFulfilled: function (response) {
    return {
      type: types.UPDATE_AUTH_PHOTO_FULFILLED,
      payload: response
    };
  },
  updateAuthPhotoRejected: function (response) {
    return {
