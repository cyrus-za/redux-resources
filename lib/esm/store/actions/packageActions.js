...
export var packageActions = __assign(__assign({}, types), {
  getPackages: function (query, successCb, errorCb) {
    if (query === void 0) {
      query = {};
    }
  ...
  getPackagesInitialState: function () {
    return {
      type: types.GET_PACKAGES_INITIAL_STATE,
      payload: null
    };
  },
  getPackagesLoading: function () {
    return {
      type: types.GET_PACKAGES_LOADING,
      payload: null
    };
  },
  getPackagesFulfilled: function (response) {
    return {
      type: types.GET_PACKAGES_FULFILLED,
      payload: response
    };
  },
  getPackagesRejected: function (response) {
    return {
  ...
  getPackageLexiconInitialState: function () {
    return {
      type: types.GET_PACKAGE_LEXICON_INITIAL_STATE,
      payload: null
    };
  },
  getPackageLexiconLoading: function () {
    return {
      type: types.GET_PACKAGE_LEXICON_LOADING,
      payload: null
    };
  },
  getPackageLexiconFulfilled: function (response) {
    return {
      type: types.GET_PACKAGE_LEXICON_FULFILLED,
      payload: response
    };
  },
  getPackageLexiconRejected: function (response) {
    return {
      type: types.GET_PACKAGE_LEXICON_REJECTED,
      payload: response
    };
  },
  createPackage: function (data, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  createPackageInitialState: function () {
    return {
      type: types.CREATE_PACKAGE_INITIAL_STATE,
      payload: null
    };
  },
  createPackageLoading: function () {
    return {
      type: types.CREATE_PACKAGE_LOADING,
      payload: null
    };
  },
  createPackageFulfilled: function (response) {
    return {
      type: types.CREATE_PACKAGE_FULFILLED,
      payload: response
    };
  },
  createPackageRejected: function (response) {
    return {
      type: types.CREATE_PACKAGE_REJECTED,
      payload: response
    };
  },
  showPackage: function (id, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  showPackageInitialState: function () {
    return {
  ...
  showPackageFulfilled: function (response) {
    return {
      type: types.SHOW_PACKAGE_FULFILLED,
      payload: response
    };
  },
  showPackageRejected: function (response) {
    return {
      type: types.SHOW_PACKAGE_REJECTED,
      payload: response
    };
  },
  updatePackage: function (id, data, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  updatePackageInitialState: function () {
    return {
      type: types.UPDATE_PACKAGE_INITIAL_STATE,
      payload: null
    };
  },
  updatePackageLoading: function () {
    return {
      type: types.UPDATE_PACKAGE_LOADING,
      payload: null
    };
  },
  updatePackageFulfilled: function (response) {
    return {
      type: types.UPDATE_PACKAGE_FULFILLED,
      payload: response
    };
  },
  updatePackageRejected: function (response) {
    return {
      type: types.UPDATE_PACKAGE_REJECTED,
      payload: response
    };
  },
  deletePackage: function (id, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  deletePackageInitialState: function () {
    return {
      type: types.DELETE_PACKAGE_INITIAL_STATE,
      payload: null
    };
  },
  deletePackageLoading: function () {
    return {
      type: types.DELETE_PACKAGE_LOADING,
      payload: null
    };
  },
  deletePackageFulfilled: function (response) {
    return {
      type: types.DELETE_PACKAGE_FULFILLED,
      payload: response
    };
  },
  deletePackageRejected: function (response) {
    return {
  ...
  getPackageRecipientsInitialState: function () {
    return {
      type: types.GET_PACKAGE_RECIPIENTS_INITIAL_STATE,
      payload: null
    };
  },
  getPackageRecipientsLoading: function () {
    return {
      type: types.GET_PACKAGE_RECIPIENTS_LOADING,
      payload: null
    };
  },
  getPackageRecipientsFulfilled: function (response) {
    return {
      type: types.GET_PACKAGE_RECIPIENTS_FULFILLED,
      payload: response
    };
  },
  getPackageRecipientsRejected: function (response) {
    return {
      type: types.GET_PACKAGE_RECIPIENTS_REJECTED,
      payload: response
    };
  },
  createPackageRecipient: function (id, data, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  createPackageRecipientInitialState: function () {
    return {
      type: types.CREATE_PACKAGE_RECIPIENT_INITIAL_STATE,
      payload: null
    };
  },
  createPackageRecipientLoading: function () {
    return {
      type: types.CREATE_PACKAGE_RECIPIENT_LOADING,
      payload: null
    };
  },
  createPackageRecipientFulfilled: function (response) {
    return {
      type: types.CREATE_PACKAGE_RECIPIENT_FULFILLED,
      payload: response
    };
  },
  createPackageRecipientRejected: function (response) {
    return {
      type: types.CREATE_PACKAGE_RECIPIENT_REJECTED,
      payload: response
    };
  },
  updatePackageRecipient: function (id, recipientId, data, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  updatePackageRecipientInitialState: function () {
    return {
      type: types.UPDATE_PACKAGE_RECIPIENT_INITIAL_STATE,
      payload: null
    };
  },
  updatePackageRecipientLoading: function () {
    return {
      type: types.UPDATE_PACKAGE_RECIPIENT_LOADING,
      payload: null
    };
  },
  updatePackageRecipientFulfilled: function (response) {
    return {
      type: types.UPDATE_PACKAGE_RECIPIENT_FULFILLED,
      payload: response
    };
  },
  updatePackageRecipientRejected: function (response) {
    return {
      type: types.UPDATE_PACKAGE_RECIPIENT_REJECTED,
      payload: response
    };
  },
  deletePackageRecipient: function (id, recipientId, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  deletePackageRecipientInitialState: function () {
    return {
      type: types.DELETE_PACKAGE_RECIPIENT_INITIAL_STATE,
      payload: null
    };
  },
  deletePackageRecipientLoading: function () {
    return {
      type: types.DELETE_PACKAGE_RECIPIENT_LOADING,
      payload: null
    };
  },
  deletePackageRecipientFulfilled: function (response) {
    if (response === void 0) {
      response = undefined;
    }
  ...
  deletePackageRecipientRejected: function (response) {
    return {
  ...
  getPackageDocumentsInitialState: function () {
    return {
      type: types.GET_PACKAGE_DOCUMENTS_INITIAL_STATE,
      payload: null
    };
  },
  getPackageDocumentsLoading: function () {
    return {
      type: types.GET_PACKAGE_DOCUMENTS_LOADING,
      payload: null
    };
  },
  getPackageDocumentsFulfilled: function (response) {
    return {
      type: types.GET_PACKAGE_DOCUMENTS_FULFILLED,
      payload: response
    };
  },
  getPackageDocumentsRejected: function (response) {
    return {
      type: types.GET_PACKAGE_DOCUMENTS_REJECTED,
      payload: response
    };
  },
  createPackageDocuments: function (id, data, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  createPackageDocumentsInitialState: function () {
    return {
      type: types.CREATE_PACKAGE_DOCUMENTS_INITIAL_STATE,
      payload: null
    };
  },
  createPackageDocumentsLoading: function () {
    return {
      type: types.CREATE_PACKAGE_DOCUMENTS_LOADING,
      payload: null
    };
  },
  createPackageDocumentsFulfilled: function (response) {
    return {
      type: types.CREATE_PACKAGE_DOCUMENTS_FULFILLED,
      payload: response
    };
  },
  createPackageDocumentsRejected: function (response) {
    return {
      type: types.CREATE_PACKAGE_DOCUMENTS_REJECTED,
      payload: response
    };
  },
  updateDocument: function (packageId, documentId, data, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  updateDocumentInitialState: function () {
    return {
      type: types.UPDATE_DOCUMENT_INITIAL_STATE,
      payload: null
    };
  },
  updateDocumentLoading: function () {
    return {
      type: types.UPDATE_DOCUMENT_LOADING,
      payload: null
    };
  },
  updateDocumentFulfilled: function (response) {
    return {
      type: types.UPDATE_DOCUMENT_FULFILLED,
      payload: response
    };
  },
  updateDocumentRejected: function (response) {
    return {
      type: types.UPDATE_DOCUMENT_REJECTED,
      payload: response
    };
  },
  createDocumentFromSocialAccount: function (id, socialAccountId, externalFileId, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  createDocumentFromSocialAccountInitialState: function () {
    return {
      type: types.CREATE_DOCUMENT_FROM_CONNECTED_SERVICE_INITIAL_STATE,
      payload: null
    };
  },
  createDocumentFromSocialAccountLoading: function () {
    return {
      type: types.CREATE_DOCUMENT_FROM_CONNECTED_SERVICE_LOADING,
      payload: null
    };
  },
  createDocumentFromSocialAccountFulfilled: function (response) {
    return {
      type: types.CREATE_DOCUMENT_FROM_CONNECTED_SERVICE_FULFILLED,
      payload: response
    };
  },
  createDocumentFromSocialAccountRejected: function (response) {
    return {
      type: types.CREATE_DOCUMENT_FROM_CONNECTED_SERVICE_REJECTED,
      payload: response
    };
  },
  downloadPackageDocument: function (id, documentId, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  getPackageImageUrl: function (id, image_url, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  getDocumentImageUrl: function (documentId, image_url, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  setDocumentImageUrl: function (documentId, imageUrl) {
    return {
  ...
  getDocumentPageImageUrl: function (documentId, pageId, image_url, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  setDocumentPageImageUrl: function (documentId, pageId, imageUrl) {
    return {
  ...
  deleteDocument: function (id, documentId, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  deleteDocumentInitialState: function () {
    return {
      type: types.DELETE_DOCUMENT_INITIAL_STATE,
      payload: null
    };
  },
  deleteDocumentLoading: function () {
    return {
      type: types.DELETE_DOCUMENT_LOADING,
      payload: null
    };
  },
  deleteDocumentFulfilled: function (documentId) {
    return {
      type: types.DELETE_DOCUMENT_FULFILLED,
      payload: documentId
    };
  },
  deleteDocumentRejected: function (response) {
    return {
  ...
  publish: function (packageId, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
