...
export var feedbackActions = __assign(__assign({}, types), {
  sendFeedback: function (payload, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  setSendFeedbackLoading: function () {
    return {
      type: types.SET_SEND_FEEDBACK_LOADING,
      payload: null
    };
  },
  setSendFeedbackFulfilled: function (response) {
    return {
      type: types.SET_SEND_FEEDBACK_FULFILLED,
      payload: response
    };
  },
  setSendFeedbackRejected: function (response) {
    return {
