...
export var contactActions = __assign(__assign({}, types), {
  searchContacts: function (payload, successCb, errorCb) {
    return {
  ...
  setSearchContactsLoading: function () {
    return {
      type: types.SEARCH_LOADING,
      payload: null
    };
  },
  setSearchContactsFulfilled: function (response) {
    return {
      type: types.SEARCH_FULFILLED,
      payload: response
    };
  },
  setSearchContactsRejected: function (response) {
    return {
