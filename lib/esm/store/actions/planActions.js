...
export var planActions = __assign(__assign({}, types), {
  getPlans: function (query) {
    if (query === void 0) {
      query = {};
    }
  ...
  setPlansInitialState: function () {
    return {
      type: types.SET_PLANS_INITIAL_STATE,
      payload: null
    };
  },
  setPlansLoading: function () {
    return {
      type: types.SET_PLANS_LOADING,
      payload: null
    };
  },
  setPlansFulfilled: function (response) {
    return {
      type: types.SET_PLANS_FULFILLED,
      payload: response
    };
  },
  setPlansRejected: function (response) {
    return {
