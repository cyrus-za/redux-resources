...
export var cardActions = __assign(__assign({}, types), {
  ...
  getCardsInitialState: function () {
    return {
      type: types.GET_CARDS_INITIAL_STATE,
      payload: null
    };
  },
  getCardsLoading: function () {
    return {
      type: types.GET_CARDS_LOADING,
      payload: null
    };
  },
  getCardsFulfilled: function (response) {
    return {
      type: types.GET_CARDS_FULFILLED,
      payload: response
    };
  },
  getCardsRejected: function (response) {
    return {
      type: types.GET_CARDS_REJECTED,
      payload: response
    };
  },
  createCard: function (card, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  createCardInitialState: function () {
    return {
      type: types.CREATE_CARD_INITIAL_STATE,
      payload: null
    };
  },
  createCardLoading: function () {
    return {
      type: types.CREATE_CARD_LOADING,
      payload: null
    };
  },
  createCardFulfilled: function (response) {
    return {
      type: types.CREATE_CARD_FULFILLED,
      payload: response
    };
  },
  createCardRejected: function (response) {
    return {
  ...
  showCardInitialState: function () {
    return {
      type: types.SHOW_CARD_INITIAL_STATE,
      payload: null
    };
  },
  showCardLoading: function () {
    return {
      type: types.SHOW_CARD_LOADING,
      payload: null
    };
  },
  showCardFulfilled: function (response) {
    return {
      type: types.SHOW_CARD_FULFILLED,
      payload: response
    };
  },
  showCardRejected: function (response) {
    return {
      type: types.SHOW_CARD_REJECTED,
      payload: response
    };
  },
  updateCard: function (id, card, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  updateCardInitialState: function () {
    return {
      type: types.UPDATE_CARD_INITIAL_STATE,
      payload: null
    };
  },
  updateCardLoading: function () {
    return {
      type: types.UPDATE_CARD_LOADING,
      payload: null
    };
  },
  updateCardFulfilled: function (response) {
    return {
      type: types.UPDATE_CARD_FULFILLED,
      payload: response
    };
  },
  updateCardRejected: function (response) {
    return {
      type: types.UPDATE_CARD_REJECTED,
      payload: response
    };
  },
  deleteCard: function (card, successCb, errorCb) {
    if (successCb === void 0) {
      successCb = undefined;
    }
  ...
  deleteCardInitialState: function () {
    return {
      type: types.DELETE_CARD_INITIAL_STATE,
      payload: null
    };
  },
  deleteCardLoading: function () {
    return {
      type: types.DELETE_CARD_LOADING,
      payload: null
    };
  },
  deleteCardFulfilled: function (response) {
    return {
      type: types.DELETE_CARD_FULFILLED,
      payload: response
    };
  },
  deleteCardRejected: function (response) {
    return {
      type: types.DELETE_CARD_REJECTED,
      payload: response
    };
  },
  setDefaultCard: function (card) {
    return {
  ...
  setDefaultCardInitialState: function () {
    return {
      type: types.SET_DEFAULT_CARD_INITIAL_STATE,
      payload: null
    };
  },
  setDefaultCardLoading: function () {
    return {
      type: types.SET_DEFAULT_CARD_LOADING,
      payload: null
    };
  },
  setDefaultCardFulfilled: function (response) {
    return {
      type: types.SET_DEFAULT_CARD_FULFILLED,
      payload: response
    };
  },
  setDefaultCardRejected: function (response) {
    return {
