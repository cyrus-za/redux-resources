...
export var folderActions = __assign(__assign({}, types), {
  ...
  getFoldersInitialState: function () {
    return {
      type: types.GET_FOLDERS_INITIAL_STATE,
      payload: null
    };
  },
  getFoldersLoading: function () {
    return {
      type: types.GET_FOLDERS_LOADING,
      payload: null
    };
  },
  getFoldersFulfilled: function (response) {
    return {
      type: types.GET_FOLDERS_FULFILLED,
      payload: response
    };
  },
  getFoldersRejected: function (response) {
    return {
  ...
  createFolderInitialState: function () {
    return {
      type: types.CREATE_FOLDER_INITIAL_STATE,
      payload: null
    };
  },
  createFolderLoading: function () {
    return {
      type: types.CREATE_FOLDER_LOADING,
      payload: null
    };
  },
  createFolderFulfilled: function (response) {
    return {
      type: types.CREATE_FOLDER_FULFILLED,
      payload: response
    };
  },
  createFolderRejected: function (response) {
    return {
  ...
  updateFolderInitialState: function () {
    return {
      type: types.UPDATE_FOLDER_INITIAL_STATE,
      payload: null
    };
  },
  updateFolderLoading: function () {
    return {
      type: types.UPDATE_FOLDER_LOADING,
      payload: null
    };
  },
  updateFolderFulfilled: function (response) {
    return {
      type: types.UPDATE_FOLDER_FULFILLED,
      payload: response
    };
  },
  updateFolderRejected: function (response) {
    return {
