...
export var fieldTypeActions = __assign(__assign({}, types), {
  getFieldTypes: function (query) {
    if (query === void 0) {
      query = {};
    }
  ...
  setFieldTypesLoading: function () {
    return {
      type: types.FIELD_TYPES_LOADING,
      payload: null
    };
  },
  setFieldTypesFulfilled: function (response) {
    return {
      type: types.FIELD_TYPES_FULFILLED,
      payload: response
    };
  },
  setFieldTypesRejected: function (data) {
    return {
