...
exports.accountActions = __assign(__assign({}, types), { showAccount: function (id) { return ({
        type: types.SHOW_ACCOUNT,
        payload: null,
        id: id,
    }); }, showAccountInitialState: function () { return ({
        type: types.SHOW_ACCOUNT_INITIAL_STATE,
        payload: null,
    }); }, showAccountLoading: function () { return ({
        type: types.SHOW_ACCOUNT_LOADING,
        payload: null,
    }); }, showAccountFulfilled: function (response) { return ({
        type: types.SHOW_ACCOUNT_FULFILLED,
        payload: response,
    }); }, showAccountRejected: function (response) { return ({
        type: types.SHOW_ACCOUNT_REJECTED,
        payload: response,
    }); }, updateAccount: function (account, data, successCb, errorCb) { return ({
        ...
        successCb: successCb,
        errorCb: errorCb,
    }); }, updateAccountInitialState: function () { return ({
        type: types.UPDATE_ACCOUNT_INITIAL_STATE,
        payload: null,
    }); }, updateAccountLoading: function () { return ({
        type: types.UPDATE_ACCOUNT_LOADING,
        payload: null,
    }); }, updateAccountFulfilled: function (response) { return ({
        type: types.UPDATE_ACCOUNT_FULFILLED,
        payload: response,
    }); }, updateAccountRejected: function (response) { return ({
        type: types.UPDATE_ACCOUNT_REJECTED,
        payload: response,
    }); }, accountUsers: function (id) { return ({
        type: types.LOAD_ACCOUNT_USERS,
        payload: null,
        id: id,
    }); }, accountUsersInitialState: function () { return ({
        type: types.LOAD_ACCOUNT_USERS_INITIAL_STATE,
        payload: null,
    }); }, accountUsersLoading: function () { return ({
        type: types.LOAD_ACCOUNT_USERS_LOADING,
        payload: null,
    }); }, accountUsersFulfilled: function (response) { return ({
        type: types.LOAD_ACCOUNT_USERS_FULFILLED,
        payload: response,
    }); }, accountUsersRejected: function (response) { return ({
        type: types.LOAD_ACCOUNT_USERS_REJECTED,
        payload: response,
    }); }, accounts: function () { return ({
        type: types.LOAD_ACCOUNTS,
        payload: null,
    }); }, accountsInitialState: function () { return ({
        type: types.LOAD_ACCOUNTS_INITIAL_STATE,
        payload: null,
    }); }, accountsLoading: function () { return ({
        type: types.LOAD_ACCOUNTS_LOADING,
        payload: null,
    }); }, accountsFulfilled: function (response) { return ({
        type: types.LOAD_ACCOUNTS_FULFILLED,
        payload: response,
    }); }, accountsRejected: function (response) { return ({
        type: types.LOAD_ACCOUNTS_REJECTED,
        payload: response,
    }); }, getDefaultAccount: function () { return ({
        type: types.LOAD_DEFAULT_ACCOUNT,
        payload: null,
    }); }, getDefaultAccountInitialState: function () { return ({
        type: types.LOAD_DEFAULT_ACCOUNT_INITIAL_STATE,
        payload: null,
    }); }, getDefaultAccountLoading: function () { return ({
        type: types.LOAD_DEFAULT_ACCOUNT_LOADING,
        payload: null,
    }); }, getDefaultAccountFulfilled: function (response) { return ({
        type: types.LOAD_DEFAULT_ACCOUNT_FULFILLED,
        payload: response,
    }); }, getDefaultAccountRejected: function (response) { return ({
        type: types.LOAD_DEFAULT_ACCOUNT_REJECTED,
        payload: response,
    }); }, setDefaultAccount: function (id) { return ({
        type: types.SET_DEFAULT_ACCOUNT,
        payload: null,
        id: id,
    }); }, setDefaultAccountInitialState: function () { return ({
        type: types.SET_DEFAULT_ACCOUNT_INITIAL_STATE,
        payload: null,
    }); }, setDefaultAccountLoading: function () { return ({
        type: types.SET_DEFAULT_ACCOUNT_LOADING,
        payload: null,
    }); }, setDefaultAccountFulfilled: function (response) { return ({
        type: types.SET_DEFAULT_ACCOUNT_FULFILLED,
        payload: response,
    }); }, setDefaultAccountRejected: function (response) { return ({
        type: types.SET_DEFAULT_ACCOUNT_REJECTED,
        payload: response,
    }); }, createAccount: function (account, successCb, errorCb) { return ({
        type: types.CREATE_ACCOUNT,
        payload: null,
        account: account,
        successCb: successCb,
        errorCb: errorCb,
    }); }, createAccountInitialState: function () { return ({
        type: types.CREATE_ACCOUNT_INITIAL_STATE,
        payload: null,
    }); }, createAccountLoading: function () { return ({
        type: types.CREATE_ACCOUNT_LOADING,
        payload: null,
    }); }, createAccountFulfilled: function (response) { return ({
        type: types.CREATE_ACCOUNT_FULFILLED,
        payload: response,
    }); }, createAccountRejected: function (response) { return ({
        type: types.CREATE_ACCOUNT_REJECTED,
        payload: response,
    }); }, deleteAccountMember: function (account, member, successCb, errorCb) { return ({
        ...
        successCb: successCb,
        errorCb: errorCb,
    }); }, deleteAccountMemberInitialState: function () { return ({
        type: types.DELETE_ACCOUNT_MEMBER_INITIAL_STATE,
        payload: null,
    }); }, deleteAccountMemberLoading: function () { return ({
        type: types.DELETE_ACCOUNT_MEMBER_LOADING,
        payload: null,
    }); }, deleteAccountMemberFulfilled: function (response) { return ({
        type: types.DELETE_ACCOUNT_MEMBER_FULFILLED,
        payload: response,
    }); }, deleteAccountMemberRejected: function (response) { return ({
        type: types.DELETE_ACCOUNT_MEMBER_REJECTED,
        payload: response,
    }); }, updateAccountMember: function (account, member, data, successCb, errorCb) { return ({
        ...
        successCb: successCb,
        errorCb: errorCb,
    }); }, updateAccountMemberInitialState: function () { return ({
        type: types.UPDATE_ACCOUNT_MEMBER_INITIAL_STATE,
        payload: null,
    }); }, updateAccountMemberLoading: function () { return ({
        type: types.UPDATE_ACCOUNT_MEMBER_LOADING,
        payload: null,
    }); }, updateAccountMemberFulfilled: function (response) { return ({
        type: types.UPDATE_ACCOUNT_MEMBER_FULFILLED,
        payload: response,
    }); }, updateAccountMemberRejected: function (response) { return ({
        type: types.UPDATE_ACCOUNT_MEMBER_REJECTED,
        payload: response,
    }); }, updateAccountPhoto: function (id, data, successCb, errorCb) { return ({
        type: types.UPDATE_ACCOUNT_PHOTO,
        payload: data,
        id: id,
        successCb: successCb,
        errorCb: errorCb,
    }); }, updateAccountPhotoInitialState: function () { return ({
        type: types.UPDATE_ACCOUNT_PHOTO_INITIAL_STATE,
        payload: null,
    }); }, updateAccountPhotoLoading: function () { return ({
        type: types.UPDATE_ACCOUNT_PHOTO_LOADING,
        payload: null,
    }); }, updateAccountPhotoFulfilled: function (response) { return ({
        type: types.UPDATE_ACCOUNT_PHOTO_FULFILLED,
        payload: response,
    }); }, updateAccountPhotoRejected: function (response) { return ({
        type: types.UPDATE_ACCOUNT_PHOTO_REJECTED,
        payload: response,
    }); }, getInvoices: function (account) { return ({
        type: types.GET_INVOICES,
        payload: null,
        account: account,
    }); }, getInvoicesInitialState: function () { return ({
        type: types.GET_INVOICES_INITIAL_STATE,
        payload: null,
    }); }, getInvoicesLoading: function () { return ({
        type: types.GET_INVOICES_LOADING,
        payload: null,
    }); }, getInvoicesFulfilled: function (response) { return ({
        type: types.GET_INVOICES_FULFILLED,
        payload: response,
    }); }, getInvoicesRejected: function (response) { return ({
