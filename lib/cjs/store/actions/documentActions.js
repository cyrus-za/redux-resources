...
exports.documentActions = __assign(__assign({}, types), { getDocuments: function (query) {
    ...
    }, getDocumentsInitialState: function () { return ({
        type: types.GET_DOCUMENTS_INITIAL_STATE,
        payload: null,
    }); }, getDocumentsLoading: function () { return ({
        type: types.GET_DOCUMENTS_LOADING,
        payload: null,
    }); }, getDocumentsFulfilled: function (response) { return ({
        type: types.GET_DOCUMENTS_FULFILLED,
        payload: response,
    }); }, getDocumentsRejected: function (response) { return ({
    ...
    }, downloadDocumentInitialState: function () { return ({
        type: types.DOWNLOAD_DOCUMENT_INITIAL_STATE,
        payload: null,
    }); }, downloadDocumentLoading: function () { return ({
        type: types.DOWNLOAD_DOCUMENT_LOADING,
        payload: null,
    }); }, downloadDocumentFulfilled: function (response) { return ({
        type: types.DOWNLOAD_DOCUMENT_FULFILLED,
        payload: response,
    }); }, downloadDocumentRejected: function (response) { return ({
