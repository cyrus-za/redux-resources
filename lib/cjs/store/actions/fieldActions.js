...
exports.fieldActions = __assign(__assign({}, types), { getFields: function (packageId, query, successCb, errorCb) {
    ...
    }, getFieldsInitialState: function () { return ({
        type: types.GET_FIELDS_INITIAL_STATE,
        payload: null,
    }); }, getFieldsLoading: function () { return ({
        type: types.GET_FIELDS_LOADING,
        payload: null,
    }); }, getFieldsFulfilled: function (response) { return ({
        type: types.GET_FIELDS_FULFILLED,
        payload: response,
    }); }, getFieldsRejected: function (response) { return ({
        type: types.GET_FIELDS_REJECTED,
        payload: response,
    }); }, createField: function (packageId, documentId, data, successCb, errorCb) { return ({
        ...
        successCb: successCb,
        errorCb: errorCb,
    }); }, updateField: function (packageId, documentId, fieldId, data, successCb, errorCb) { return ({
        ...
        successCb: successCb,
        errorCb: errorCb,
    }); }, deleteField: function (packageId, documentId, fieldId, successCb, errorCb) { return ({
        ...
        successCb: successCb,
        errorCb: errorCb,
    }); }, setItemLoading: function () { return ({
        type: types.SET_ITEM_LOADING,
        payload: null,
    }); }, setItemFulfilled: function (response) { return ({
        type: types.SET_ITEM_FULFILLED,
        payload: response,
    }); }, setItemRejected: function (response) { return ({
