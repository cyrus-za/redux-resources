...
exports.subscriptionActions = __assign(__assign({}, types), { getSubscriptions: function (query) {
    ...
    }, setSubscriptionsLoading: function () { return ({
        type: types.SET_SUBSCRIPTIONS_LOADING,
        payload: null,
    }); }, setSubscriptionsFulfilled: function (response) { return ({
        type: types.SET_SUBSCRIPTIONS_FULFILLED,
        payload: response,
    }); }, setSubscriptionsRejected: function (response) { return ({
    ...
    }, setCreateSubscriptionLoading: function () { return ({
        type: types.SET_CREATE_SUBSCRIPTION_LOADING,
        payload: null,
    }); }, setCreateSubscriptionFulfilled: function (response) { return ({
        type: types.SET_CREATE_SUBSCRIPTION_FULFILLED,
        payload: response,
    }); }, setCreateSubscriptionRejected: function (response) { return ({
    ...
    }, setUpdateSubscriptionLoading: function () { return ({
        type: types.SET_UPDATE_SUBSCRIPTION_LOADING,
        payload: null,
    }); }, setUpdateSubscriptionFulfilled: function (response) { return ({
        type: types.SET_UPDATE_SUBSCRIPTION_FULFILLED,
        payload: response,
    }); }, setUpdateSubscriptionRejected: function (response) { return ({
        type: types.SET_UPDATE_SUBSCRIPTION_REJECTED,
        payload: response,
    }); }, deleteSubscription: function (subscription, successCb, errorCb) { return ({
        type: types.DELETE_SUBSCRIPTION,
        payload: null,
        subscription: subscription,
        successCb: successCb,
        errorCb: errorCb,
    }); }, setDeleteSubscriptionLoading: function () { return ({
        type: types.SET_DELETE_SUBSCRIPTION_LOADING,
        payload: null,
    }); }, setDeleteSubscriptionFulfilled: function (response) { return ({
        type: types.SET_DELETE_SUBSCRIPTION_FULFILLED,
        payload: response,
    }); }, setDeleteSubscriptionRejected: function (response) { return ({
