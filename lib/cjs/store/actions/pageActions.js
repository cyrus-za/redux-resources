...
exports.pageActions = __assign(__assign({}, types), { getPages: function (packageId, documentId, successCb, errorCb) { return ({
        ...
        payload: response,
    }); }, getPageImage: function (pageId, image_url, successCb, errorCb) { return ({
        ...
        successCb: successCb,
        errorCb: errorCb,
    }); }, setPageImage: function (pageId, image) { return ({
