...
exports.signatureActions = __assign(__assign({}, types), { getSignatures: function () { return ({
        type: types.GET_SIGNATURES,
        payload: null,
    }); }, setSignaturesLoading: function () { return ({
        type: types.SIGNATURES_LOADING,
        payload: null,
    }); }, setSignaturesFulfilled: function (response) { return ({
        type: types.SIGNATURES_FULFILLED,
        payload: response,
    }); }, setSignaturesRejected: function (data) { return ({
        type: types.SET_SIGNATURES_REJECTED,
        payload: data,
    }); }, createSignature: function (data) { return ({
        type: types.CREATE_SIGNATURE,
        payload: null,
        data: data,
    }); }, setCreateSignatureLoading: function () { return ({
        type: types.CREATE_SIGNATURE_LOADING,
        payload: null,
    }); }, setCreateSignatureFulfilled: function (response) { return ({
        type: types.CREATE_SIGNATURE_FULFILLED,
        payload: response,
    }); }, setCreateSignatureRejected: function (data) { return ({
