...
exports.userActions = __assign(__assign({}, types), { updatePassword: function (id, payload, successCb, errorCb) { return ({
        type: types.UPDATE_PASSWORD,
        payload: payload,
        id: id,
        successCb: successCb,
        errorCb: errorCb,
    }); }, updatePasswordInitialState: function () { return ({
        type: types.UPDATE_PASSWORD_INITIAL_STATE,
        payload: null,
    }); }, updatePasswordLoading: function () { return ({
        type: types.UPDATE_PASSWORD_LOADING,
        payload: null,
    }); }, updatePasswordFulfilled: function (response) { return ({
        type: types.UPDATE_PASSWORD_FULFILLED,
        payload: response,
    }); }, updatePasswordRejected: function (response) { return ({
        type: types.UPDATE_PASSWORD_REJECTED,
        payload: response,
    }); }, confirmEmail: function (token, successCb, errorCb) { return ({
        type: types.CONFIRM_EMAIL,
        payload: null,
        token: token,
        successCb: successCb,
        errorCb: errorCb,
    }); }, confirmEmailInitialState: function () { return ({
        type: types.CONFIRM_EMAIL_INITIAL_STATE,
        payload: null,
    }); }, confirmEmailLoading: function () { return ({
        type: types.CONFIRM_EMAIL_LOADING,
        payload: null,
    }); }, confirmEmailFulfilled: function () { return ({
        type: types.CONFIRM_EMAIL_FULFILLED,
        payload: null,
    }); }, confirmEmailRejected: function (response) { return ({
        type: types.CONFIRM_EMAIL_REJECTED,
        payload: response,
    }); }, resendEmailConfirmation: function (payload) { return ({
        type: types.RESEND_EMAIL_CONFIRMATION,
        payload: payload,
    }); }, resendEmailConfirmationInitialState: function () { return ({
        type: types.RESEND_EMAIL_CONFIRMATION_INITIAL_STATE,
        payload: null,
    }); }, resendEmailConfirmationLoading: function () { return ({
        type: types.RESEND_EMAIL_CONFIRMATION_LOADING,
        payload: null,
    }); }, resendEmailConfirmationFulfilled: function (response) { return ({
        type: types.RESEND_EMAIL_CONFIRMATION_FULFILLED,
        payload: response,
    }); }, resendEmailConfirmationRejected: function (response) { return ({
        type: types.RESEND_EMAIL_CONFIRMATION_REJECTED,
        payload: response,
    }); }, getNotificationPreferences: function (id, payload) { return ({
        type: types.GET_NOTIFICATION_PREFERENCES,
        payload: payload,
        id: id,
    }); }, getNotificationPreferencesInitialState: function () { return ({
        type: types.GET_NOTIFICATION_PREFERENCES_INITIAL_STATE,
        payload: null,
    }); }, getNotificationPreferencesLoading: function () { return ({
        type: types.GET_NOTIFICATION_PREFERENCES_LOADING,
        payload: null,
    }); }, getNotificationPreferencesFulfilled: function (response) { return ({
        type: types.GET_NOTIFICATION_PREFERENCES_FULFILLED,
        payload: response,
    }); }, getNotificationPreferencesRejected: function (response) { return ({
        type: types.GET_NOTIFICATION_PREFERENCES_REJECTED,
        payload: response,
    }); }, updateNotificationPreferences: function (id, payload) { return ({
        type: types.UPDATE_NOTIFICATION_PREFERENCES,
        payload: payload,
        id: id,
    }); }, updateNotificationPreferencesInitialState: function () { return ({
        type: types.UPDATE_NOTIFICATION_PREFERENCES_INITIAL_STATE,
        payload: null,
    }); }, updateNotificationPreferencesLoading: function () { return ({
        type: types.UPDATE_NOTIFICATION_PREFERENCES_LOADING,
        payload: null,
    }); }, updateNotificationPreferencesFulfilled: function (response) { return ({
        type: types.UPDATE_NOTIFICATION_PREFERENCES_FULFILLED,
        payload: response,
    }); }, updateNotificationPreferencesRejected: function (response) { return ({
