...
exports.accountInviteActions = __assign(__assign({}, types), { getMyAccountInvites: function () { return ({
        type: types.GET_MY_ACCOUNT_INVITES,
        payload: null,
    }); }, getMyAccountInvitesInitialState: function () { return ({
        type: types.GET_MY_ACCOUNT_INVITES_INITIAL_STATE,
        payload: null,
    }); }, getMyAccountInvitesLoading: function () { return ({
        type: types.GET_MY_ACCOUNT_INVITES_LOADING,
        payload: null,
    }); }, getMyAccountInvitesFulfilled: function (response) { return ({
        type: types.GET_MY_ACCOUNT_INVITES_FULFILLED,
        payload: response,
    }); }, getMyAccountInvitesRejected: function (response) { return ({
        type: types.GET_MY_ACCOUNT_INVITES_REJECTED,
        payload: response,
    }); }, getAccountInvites: function (query) { return ({
        type: types.GET_ACCOUNT_INVITES,
        payload: null,
        query: query,
    }); }, accountInvitesInitialState: function () { return ({
        type: types.GET_ACCOUNT_INVITES_INITIAL_STATE,
        payload: null,
    }); }, accountInvitesLoading: function () { return ({
        type: types.GET_ACCOUNT_INVITES_LOADING,
        payload: null,
    }); }, accountInvitesFulfilled: function (response) { return ({
        type: types.GET_ACCOUNT_INVITES_FULFILLED,
        payload: response,
    }); }, accountInvitesRejected: function (response) { return ({
        type: types.GET_ACCOUNT_INVITES_REJECTED,
        payload: response,
    }); }, deleteMyAccountInvite: function (invite) { return ({
        type: types.DELETE_MY_ACCOUNT_INVITE,
        payload: null,
        invite: invite,
    }); }, deleteAccountInvite: function (invite, successCb, errorCb) { return ({
        type: types.DELETE_ACCOUNT_INVITE,
        payload: null,
        invite: invite,
        successCb: successCb,
        errorCb: errorCb,
    }); }, deleteAccountInviteInitialState: function () { return ({
        type: types.DELETE_ACCOUNT_INVITE_INITIAL_STATE,
        payload: null,
    }); }, deleteAccountInviteLoading: function () { return ({
        type: types.DELETE_ACCOUNT_INVITE_LOADING,
        payload: null,
    }); }, deleteAccountInviteFulfilled: function (response) { return ({
        type: types.DELETE_ACCOUNT_INVITE_FULFILLED,
        payload: response,
    }); }, deleteAccountInviteRejected: function (response) { return ({
        type: types.DELETE_ACCOUNT_INVITE_REJECTED,
        payload: response,
    }); }, createAccountInvite: function (invite, successCb, errorCb) { return ({
        type: types.CREATE_ACCOUNT_INVITE,
        payload: null,
        invite: invite,
        successCb: successCb,
        errorCb: errorCb,
    }); }, createAccountInviteInitialState: function () { return ({
        type: types.CREATE_ACCOUNT_INVITE_INITIAL_STATE,
        payload: null,
    }); }, createAccountInviteLoading: function () { return ({
        type: types.CREATE_ACCOUNT_INVITE_LOADING,
        payload: null,
    }); }, createAccountInviteFulfilled: function (response) { return ({
        type: types.CREATE_ACCOUNT_INVITE_FULFILLED,
        payload: response,
    }); }, createAccountInviteRejected: function (response) { return ({
        type: types.CREATE_ACCOUNT_INVITE_REJECTED,
        payload: response,
    }); }, acceptAccountInvite: function (invite) { return ({
        type: types.ACCEPT_ACCOUNT_INVITE,
        payload: null,
        invite: invite,
    }); }, acceptAccountInviteInitialState: function () { return ({
        type: types.ACCEPT_ACCOUNT_INVITE_INITIAL_STATE,
        payload: null,
    }); }, acceptAccountInviteLoading: function () { return ({
        type: types.ACCEPT_ACCOUNT_INVITE_LOADING,
        payload: null,
    }); }, acceptAccountInviteFulfilled: function (response) { return ({
        type: types.ACCEPT_ACCOUNT_INVITE_FULFILLED,
        payload: response,
    }); }, acceptAccountInviteRejected: function (response) { return ({
