...
exports.connectedServiceActions = __assign(__assign({}, types), { getConnectedServices: function (query) {
    ...
    }, setConnectedServicesInitialState: function () { return ({
        type: types.SET_CONNECTED_SERVICES_INITIAL_STATE,
        payload: null,
    }); }, setConnectedServicesLoading: function () { return ({
        type: types.SET_CONNECTED_SERVICES_LOADING,
        payload: null,
    }); }, setConnectedServicesFulfilled: function (response) { return ({
        type: types.SET_CONNECTED_SERVICES_FULFILLED,
        payload: response,
    }); }, setConnectedServicesRejected: function (response) { return ({
        type: types.SET_CONNECTED_SERVICES_REJECTED,
        payload: response,
    }); }, createConnectedService: function (data, successCb, errorCb) { return ({
        type: types.CREATE_CONNECTED_SERVICE,
        payload: null,
        data: data,
        successCb: successCb,
        errorCb: errorCb,
    }); }, createConnectedServiceInitialState: function () { return ({
        type: types.CREATE_CONNECTED_SERVICE_INITIAL_STATE,
        payload: null,
    }); }, createConnectedServiceLoading: function () { return ({
        type: types.CREATE_CONNECTED_SERVICE_LOADING,
        payload: null,
    }); }, createConnectedServiceFulfilled: function (response) { return ({
        type: types.CREATE_CONNECTED_SERVICE_FULFILLED,
        payload: response,
    }); }, createConnectedServiceRejected: function (response) { return ({
        type: types.CREATE_CONNECTED_SERVICE_REJECTED,
        payload: response,
    }); }, updateConnectedService: function (id, data, successCb, errorCb) { return ({
        ...
        successCb: successCb,
        errorCb: errorCb,
    }); }, updateConnectedServiceInitialState: function () { return ({
        type: types.UPDATE_CONNECTED_SERVICE_INITIAL_STATE,
        payload: null,
    }); }, updateConnectedServiceLoading: function () { return ({
        type: types.UPDATE_CONNECTED_SERVICE_LOADING,
        payload: null,
    }); }, updateConnectedServiceFulfilled: function (response) { return ({
        type: types.UPDATE_CONNECTED_SERVICE_FULFILLED,
        payload: response,
    }); }, updateConnectedServiceRejected: function (response) { return ({
    ...
    }, deleteConnectedServiceInitialState: function () { return ({
        type: types.DELETE_CONNECTED_SERVICE_INITIAL_STATE,
        payload: null,
    }); }, deleteConnectedServiceLoading: function () { return ({
        type: types.DELETE_CONNECTED_SERVICE_LOADING,
        payload: null,
    }); }, deleteConnectedServiceFulfilled: function (response) { return ({
        type: types.DELETE_CONNECTED_SERVICE_FULFILLED,
        payload: response,
    }); }, deleteConnectedServiceRejected: function (response) { return ({
        type: types.DELETE_CONNECTED_SERVICE_REJECTED,
        payload: response,
    }); }, setConnectedServices: function (list) { return ({
        type: types.SET_CONNECTED_SERVICES,
        payload: list,
    }); }, setAvailableServices: function (list) { return ({
