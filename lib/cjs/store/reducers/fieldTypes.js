...
exports.default = (function (state, action) {
    ...
    //  list
    switch (action.type) {
        case actions_1.fieldTypeActions.FIELD_TYPES_LOADING:
            return state.merge({
                list: stateUtility_1.default.getPaginationLoading(),
            });
        case actions_1.fieldTypeActions.FIELD_TYPES_FULFILLED:
            return state.merge({
                list: stateUtility_1.default.getPaginationFulfilled(action.payload.data),
            });
        case actions_1.fieldTypeActions.SET_FIELD_TYPES_REJECTED:
            return state.merge({
